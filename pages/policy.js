    ...
    <>
      ...
      <section className="bg-[#1F1F1F] px-20 py-32">
        ...
        <p className="mb-4 text-gray-400">
          ...
          hash) may be provided to Gravatar service to see if you are using it.
        ...
        <p className="mb-4 text-gray-400">
          ...
          for two days and screen options cookies last for a ayear. If you
        ...
        <p className="mb-4 text-gray-400">
          ...
          in your browser. This cookie uncludes no personal data and simply
        ...
        <h2 className="mb-4 text-white">What rights you have over your data</h2>
        <p className="mb-4 text-gray-400">
