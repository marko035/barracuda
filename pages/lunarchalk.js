...
function scoreboard() {
  ...
  return (
    <>
      <Header cart={cart} logoColor="#01B98D" logoImage="logo-lunar.svg" />
      ...
      <section className="glovesTopSection flex flex-col min-h-screen px-6 py-20 xl:px-32 xl:pt-48 items-center text-center text-white pb-0">
        <div className="text-white text-xl xl:text-3xl xl:pr-10 font-extralight mb-20">
          <p className="mt-20 xl:mt-0">
            Lunar Premium Chalk by Barracuda
            <br />
            <br />
            Introducing Lunar, the next level of chalk by Barracuda. With its
            revolutionary new formula, Lunar delivers unmatched consistency and
            ultimate grip on the cue ball, ensuring a flawless playing
            experience. Say goodbye to unnecessary misscues!Lunar provides
            superior performance for both beginners and pros alike.
            <br />
            <br />A standout feature is the integrated metal plate beneath the
            sticker, allowing the chalk to securely attach to any magnetic chalk
            holder. Elevate your game with Lunar, the chalk that sets the
            standard.
          </p>
        </div>
        ...
        <div className="flex-1">
          <img
            src={`/lunarchalk/lunarchalk-${imageNumber}.jpeg`}
          ...
          <div className="flex items-center xl:ml-[-40px] before:none after:none">
            <div
              className="hidden xl:block w-[40px] h-[40px] mt-8 lunarchalk leftArrow cursor-pointer"
            ...
            >
              {new Array(totalImages).fill().map((el, index) => (
                <img
                  ...
                  src={`/lunarchalk/lunarchalk-${index + 1}.jpeg`}
                  alt="Glove Preview"
            ...
            <div
              className="hidden xl:block w-[40px] h-[40px] mt-8 lunarchalk rightArrow cursor-pointer"
              onClick={() => nextImage()}
            ></div>
          </div>
        ...
        <div className="flex-1 text-xs xl:text-xl mb-48 text-left">
          <div className="mt-32 xl:w-[500px] mx-auto">
            <div className="border-b-2 border-b-[#01B98D] p-[10px] flex justify-between">
            ...
            <button
              onClick={() => addToCart()}
              className="w-full border-2 border-transparent bg-[#01B98D] rounded-md p-2 text-white mt-10"
            >
              add to cart
            </button>
            <Link href="/cart" passHref>
              <button className="w-full text-[#01B98D] bg-white border-2 border-[#01B98D] rounded-md mt-6 p-2">
                go to cart
              </button>
            </Link>
